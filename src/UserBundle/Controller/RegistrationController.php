...
//        $this->denyAccessUnlessGranted('ROLE_CANDIDAT', null, 'Unable to access this page!');
            ...
            if ($form->isValid()) {
               ...
               $data = $request->request;
                ...
                if ($data->get("birthdate")){
                    $bd = new \DateTime ($data->get("birthdate"));
                    $user->setDateNaissance($bd);
                }else{
...
//                    die;
         ...
         if (isset($_FILES['input-1']))
            {
                 $ouput_files= "uploads/avatar".'/'.$user->getId();
